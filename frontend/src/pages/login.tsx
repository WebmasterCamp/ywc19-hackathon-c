        ...
        <div className="fixed bottom-0 left-0 w-full rounded-t-3xl h-4/6 bg-white shadow-custom-shadow">
          <div className="p-6 h-full flex flex-col justify-between">
            <div className="space-y-4">
              <div>
                <h1 className="text-4xl font-bold text-center text-custom-dark-orange mt-8">
                  เข้าสู่ระบบ
                </h1>
              </div>
              ...
              <div className="flex flex-row-reverse">
                <p className="text-custom-dark-orange font-bold">ลืมรหัสผ่าน</p>
              </div>
              ...
              <div>
                <p className=" font-bold text-center">
                  <span className="text-[##BFBFBF]">ยังไม่มีบัญชี ?</span>{" "}
                  <span className="text-custom-dark-orange">สมัครบัญชี</span>
                </p>
              </div>
            </div>
          </div>
